...
class BlockManager:
    ...
    def __init__(self):
        ...
        self.addBlock(5, DataValues(5, [Block(5, "Oak Wood Planks", "wood"), Block(5, "Spruce Wood Planks", "wood_spruce"), Block(5, "Birch Wood Planks", "wood_birch"), Block(5, "Jungle Wood Planks", "wood_jungle")]))
        ...
        self.addBlock(43, DataValues(43, [Multitextured(43, "Double Stone Slab", textureTop="stoneslab_top", textureFront="stoneslab_side"), Multitextured(43, "Double Sandstone Slab", "sandstone_bottom", "sandstone_top", "sandstone_side"), Block(43, "Double Wooden Slab (Stone)", "wood"), Block(43, "Double Cobblestone Slab", "stonebrick"), Block(43, "Double Brick Slab", "brick"), Block(43, "Double Stone Brick Slab", "stonebricksmooth"), Block(43, "Double Nether Brick Slab", "netherBrick"), Multitextured(43, "Double Quartz Slab", "quartzblock_bottom", "quartzblock_top", "quartzblock_side"), Block(43, "Double Smooth Stone Slab", "stoneslab_top"), Block(43, "Double Smooth Sandstone Slab", "sandstone_top")]))
        self.addBlock(44, DataValues(44, [MultitexturedSlab(44, "Stone Slab", textureTop="stoneslab_top", textureFront="stoneslab_side"), MultitexturedSlab(44, "Sandstone Slab", "sandstone_bottom", "sandstone_top", "sandstone_side"), Slab(44, "Wooden Slab (Stone)", "wood"), Slab(44, "Cobblestone Slab", "stonebrick"), Slab(44, "Brick Slab", "brick"), Slab(44, "Stone Brick Slab", "stonebricksmooth"), Slab(44, "Nether Brick Slab", "netherBrick"), MultitexturedSlab(44, "Quartz Slab", "quartzblock_bottom", "quartzblock_top", "quartzblock_side")]*2))
        self.addBlock(45, Block(45, "Brick Block", "brick"))
        self.addBlock(46, Multitextured(46, "TNT", "tnt_bottom", "tnt_top", "tnt_side"))
        self.addBlock(47, Multitextured(47, "Bookshelf", textureTop="wood", textureFront="bookshelf"))
        self.addBlock(48, Block(48, "Moss Stone", "stoneMoss"))
        self.addBlock(49, Block(49, "Obsidian", "obsidian"))
        self.addBlock(53, Stairs(53, "Oak Wood Stairs", "wood"))
        self.addBlock(56, Block(56, "Diamond Ore", "oreDiamond"))
        self.addBlock(57, Block(57, "Diamond Block", "blockDiamond"))
        self.addBlock(58, Multitextured(58, "Crafting Table", "wood", "workbench_top", "workbench_front", "workbench_front", "workbench_side", "workbench_side"))
        ...
        self.addBlock(125, DataValues(125, [Block(125, "Double Oak Wood Slab", "wood"), Block(125, "Double Spruce Wood Slab", "wood_spruce"), Block(125, "Double Birch Wood Slab", "wood_birch"), Block(125, "Double Jungle Wood Slab", "wood_jungle")]))
        self.addBlock(126, DataValues(126, [Slab(126, "Oak Wood Slab", "wood"), Slab(126, "Spruce Wood Slab", "wood_spruce"), Slab(126, "Birch Wood Slab", "wood_birch"), Slab(126, "Jungle Wood Slab", "wood_jungle")]*2))
        ...
        self.addBlock(134, Stairs(134, "Spruce Wood Stairs", "wood_spruce"))
        self.addBlock(135, Stairs(135, "Birch Wood Stairs", "wood_birch"))
        self.addBlock(136, Stairs(136, "Jungle Wood Stairs", "wood_jungle"))
